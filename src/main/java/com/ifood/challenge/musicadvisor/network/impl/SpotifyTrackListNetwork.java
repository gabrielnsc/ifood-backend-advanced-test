...
import com.ifood.challenge.musicadvisor.constants.HTTPConstants;
...
import com.ifood.challenge.musicadvisor.vo.TrackDescription;
import com.ifood.challenge.musicadvisor.vo.TrackList;
import com.ifood.challenge.musicadvisor.vo.spotify.Artist;
...
public class SpotifyTrackListNetwork implements TrackListNetwork {
	...
	/*
	 * @see
	 * com.ifood.challenge.musicadvisor.network.TrackListNetwork#getTracksByGenre(
	 * com.ifood.challenge.musicadvisor.enums.TrackGenre)
	 */
	@Override
