...
import com.ifood.challenge.musicadvisor.exception.InvalidCityException;
import com.ifood.challenge.musicadvisor.exception.InvalidCoordinatesException;
import com.ifood.challenge.musicadvisor.service.TrackAdvisorService;
import com.ifood.challenge.musicadvisor.vo.ServerError;
import com.ifood.challenge.musicadvisor.vo.TrackList;
import com.ifood.challenge.util.StringUtils;

@RestController
@RequestMapping("/api/tracks")
public class TrackAdvisorController {
	@Autowired
	 ...
	 * @param longitude the latitude coordinate
	 * @returns a {@link ResponseEntity} object wrapping the response result
	 */
